...
from models.BT-HRSCD import BasicNet as Net
DATA_NAME = 'ST'
#################################
...
class PredOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--pred_dir', required=False, default='results', help='directory to output masks')
        parser.add_argument('--chkpt_path', required=False, default=working_path+'')
